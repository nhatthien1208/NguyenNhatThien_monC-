...
int main()
{
    ...
    // Sort the elements in the sales array in descending order and shuffle the ID numbers in the id array to keep them in parallel.
...
// The result is stored in the sales array.
...
// The size of these arrays is passed into size.
// This function performs a descending order selection sort on the sales array.
// The elements of the id array are exchanged identically as those of the sales array.
...
// Definition of showOrder function. Accepts sales and id arrays as arguments.
// The size of these arrays is passed into num.
// The function first displays a heading, then the sorted list of product numbers and sales.
...
// The size of these arrays is passed into num.
// The function first calculates the total units (of all products) sold and the total sales.
